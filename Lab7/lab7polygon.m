...
scene1 = imread('images/chandelier.jpg');
scene2 = imread('images/scene4.jpg');
...
% This transformation allows us to localize the object in the scene, by eliminating outliers.
...
%% Draw a bounding box around the object in the cluttered scene
objectPolygon = [1, 1;...                           % top-left
        size(scene1, 2), 1;...                 % top-right
        size(scene1, 2), size(scene1, 1);... % bottom-right
        1, size(scene2, 1);...                 % bottom-left
...
% domestic scenes using  corner points, SURF points and BRISK points. 
...
% two images of the same scene that are geometricallt misaligned due to the
